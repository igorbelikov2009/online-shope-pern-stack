...
// Импортируем как checkRole в: typeRouter, brandRouter, deviceRouter,
// 2-м параметром передаём в функцию create(). Не просто передаём, а вызываем middleware checkRole().
// Этим мы ограничиваем пользователей в создании типов, брендов, устройств.
// Такая возможность будет только у пользователя с ролью "ADMIN"
